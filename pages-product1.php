                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="ConnectData/pages-delete.php" method="post">
                                                            <input type="hidden" name="delete_id_table" value="<?php echo $row['db_product_id']; ?>">
                                                            <button type="submit" name="delete_btn_table" class="btn btn-outline-danger"><i class="mdi mdi-close font-18"></i></button>
                                                        </form>
                                                    </td>
                                                </tr>
                                        <?php
